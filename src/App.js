...
function CartApp(){
  ...
  const Product= ["Orange Juice","Tea","Coffee","Breakfast Combo","Lunch Comob","Dinner Comobo"];
     ...
     <Router>
       <Routes>
         ...
         element={
              ...
              React.createElement("h3", null, name, "  "," Qty : ", CountQty[index] ," Price : ", Price[index]), 
              React.createElement("button", { onClick: () => addItem(index) }, "Buy Now" ,"   "),
              React.createElement("button", { onClick: () => removeItem(index) }, "Remove"))),
              React.createElement("h2", null, "Total Quantity : ", totQty()),
              React.createElement("h2", null, "Total Bill : ", totalRs()),
              <Footer />
              )}/>
              <Route path='/Order' element= { <Order />} component={totalRs()} />
              </Routes>
              </Router>    
   )}
